 ...
 DECLARE @url nvarchar(4000) = 'https://azureopenaifab2602.openai.azure.com/openai/deployments/gpt-4.1/chat/completions?api-version=2025-01-01-preview';
 ...
 exec @ret = sp_invoke_external_rest_endpoint
     ...
     @method = 'POST', 
     @payload = @payload,
     @credential = [https://azureopenaifab2602.openai.azure.com],    
     @timeout = 230,
