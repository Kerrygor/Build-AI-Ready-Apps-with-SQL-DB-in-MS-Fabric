...
-- The view joins Warehouse, Suppliers, and SupplierPerformance tables
-- Includes ProductID, SupplierName, QuantityOnHand, RiskScore
-- Computes SupplyRiskLevel based on inventory and supplier risk metrics
